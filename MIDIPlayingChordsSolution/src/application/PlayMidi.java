...
public class PlayMidi {
	...
	public static void playMidi(List<Chord> list) {
		...
		try {
            ...
            for (var chord : list) {
	            ...
	            double timeFactor = (chord.getTime()/1000);
	            // Add Note On event
	            track.add(makeEvent(ShortMessage.NOTE_ON, 1, chord.getNote(), 120, ticksPerSecond * timeFactor));  //ShortMessage.NOTE_ON 144
	 
	            // Add Note Off event
	            track.add(makeEvent(ShortMessage.NOTE_OFF, 1,chord.getNote(), 120, (ticksPerSecond * timeFactor) + ticksPerSecond)); //ShortMessage.NOTE_OFF 128
            }
