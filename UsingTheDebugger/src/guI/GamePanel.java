...
//						System.out.println("Neighbors: " + world.getNeighbors(row, col));
		...
		// Executors.newScheduledThreadPool(1).scheduleAtFixedRate(() -> nextGrid(),
...
//		System.out.println("next...");
	...
	public void saveGrid(File file) {
		try {
			...
			JOptionPane.showMessageDialog(this, "Cannot save selected file.", "Error occured",
	...
	public void loadGrid(File file) {
		try {
			...
			JOptionPane.showMessageDialog(this, "Cannot open selected file.", "Error occured",
					JOptionPane.ERROR_MESSAGE);
		} catch (MismatchedSizeException e) {
			JOptionPane.showMessageDialog(this, "Loading from a different grid size.", "Warning",
